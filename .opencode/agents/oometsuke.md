---
description: "Oometsuke — final review and escalation advice"
mode: primary
# Auto-generated by build_instructions.sh — do not edit manually.
# Source: instructions/roles/oometsuke_role.md + instructions/common/* + instructions/cli_specific/opencode_tools.md
...
permission:
  ...
  glob: &id001
    ...
    dashboard.md: deny
    queue/inbox/*: deny
    queue/inbox/oometsuke.yaml: allow
    queue/ntfy_inbox.yaml: deny
    queue/reports/*: deny
    queue/reports/oometsuke_report.yaml: allow
    queue/shogun_to_karo.yaml: deny
