...
task_status_transitions:
  ...
  - "RULE: pending_blockedをassignedへ移す直前にbash scripts/verify_cmd_closed.shを実行する。nonzeroなら昇格しない。"
...
4. **Read your instructions file**: shogun→`instructions/generated/codex-shogun.md`, karo→`instructions/generated/codex-karo.md`, ashigaru→`instructions/generated/codex-ashigaru.md`, gunshi→`instructions/generated/codex-gunshi.md`, oometsuke→`instructions/generated/codex-oometsuke.md`. **NEVER SKIP** — even if a conversation summary exists. Summaries do NOT preserve persona, speech style, or forbidden actions.
