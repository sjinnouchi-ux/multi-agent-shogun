...
- [ ] **Step 2: Add a real-filesystem fixture and exact-link tests**
...
- [ ] **Step 3: Add fail-closed traversal tests before production code**
...
- [ ] **Step 4: Run each new test and verify RED**
...
- [ ] **Step 1: Add constants, binding data and source-error translation**
...
- [ ] **Step 2: Implement component-by-component directory opening**
...
- [ ] **Step 3: Implement `open_inbox_root` minimally to satisfy Task 1**
...
- [ ] **Step 5: Add binding-swap RED tests**
...
- [ ] **Step 6: Implement post-collection binding verification**
...
- [ ] **Step 7: Verify GREEN and FD cleanup**
...
- [ ] **Step 8: Commit the secure resolver**
...
- [ ] **Step 1: Add collection RED tests**
...
- [ ] **Step 2: Add the isolated integration RED test**
...
- [ ] **Step 3: Implement root selection and atomic inbox result replacement**
...
- [ ] **Step 4: Verify focused GREEN and schema compatibility**
...
- [ ] **Step 5: Commit routing and integration coverage**
...
- [ ] **Step 1: Mark the design implemented and record only sanitized evidence**
...
- [ ] **Step 2: Run all required verification on the deployment host against the dedicated clone**
...
git diff --binary a3f21a6c62bc5b3c48f0b1501caff1ace5da5544...HEAD | \
  python3 -c 'import re,sys; data=sys.stdin.buffer.read(); n=len(re.findall(rb"BEGIN (?:RSA|OPENSSH|EC) PRIVATE KEY|ghp_|github_pat_|token\s*[:=]", data, re.I)); print(f"secret_like_matches={n}"); raise SystemExit(n != 0)'
```
...
- [ ] **Step 4: Request an independent requirements and security review**
